...
def generate_html_report(result: Dict[str, Any], scenario_dir: Path, output_path: Path):
    ...
    # Build agent version table rows
    agent_version_rows = ""
    ...
    for agent_name, agent_data in sorted(agent_executions.items()):
        ...
        prompt_hash = agent_data.get('prompt_hash', 'N/A')
        ...
        agent_version_rows += f"""
                                            <tr>
                                                ...
                                                <td><small><code>{prompt_hash}</code></small></td>
                                            </tr>"""
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <p class="mb-0">Pipeline Version: {analysis_meta.get('pipeline_version', 'N/A')}</p>
                <p class="mb-0"><small>Analysis Time: {analysis_meta.get('analysis_timestamp', 'N/A')[:19]}</small></p>
            </div>
            <div class="col-md-4 text-end">
        ...
        <div class="mt-3">
            <div class="accordion accordion-flush" id="analysisDetailsAccordion">
                <div class="accordion-item bg-light border-0">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed bg-light text-muted py-2" type="button" data-bs-toggle="collapse" data-bs-target="#analysisDetails" aria-expanded="false">
                            <small>📋 Analysis Details (Agent Versions, Models, Prompts)</small>
                        </button>
                    </h2>
                    <div id="analysisDetails" class="accordion-collapse collapse" data-bs-parent="#analysisDetailsAccordion">
