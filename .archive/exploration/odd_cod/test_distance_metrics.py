...
class TestWindowDistance:
    ...
    def test_perfect_compliance(self):
        ...
        # smooth terrain, moderate speed
        cod_vector = {"speed": 0.5, "terrain": 0.0}

        distance, axis_distances, axis_statuses = compute_window_distance(
            cod_vector, odd_spec)
    ...
    def test_odd_violation(self):
        ...
        # rough terrain, high speed
        cod_vector = {"speed": 1.8, "terrain": 1.0}
...
class TestScenarioDistance:
    ...
    def test_all_compliant_windows(self):
        ...
        scenario_dist = compute_scenario_distance(
            window_distances, window_statuses)
...
class TestIntegration:
    ...
    def test_indoor_compliant_scenario(self):
        ...
        for tags in window_tags:
            ...
            distance, _, axis_statuses = compute_window_distance(
                cod_vector, odd_spec)
            status = compute_window_odd_status(axis_statuses)
        ...
        classification = classify_scenario(
            scenario_dist, statuses.count("odd_exit") / len(statuses))
