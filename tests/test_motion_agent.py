...
Usage:
    ...
    python tests/test_motion_agent.py --scenario data/processed/production/sim_run_new
...
def _extract_result(events: List[Any], agent_name: str = "MotionSummaryAgent") -> Optional[Dict[str, Any]]:
