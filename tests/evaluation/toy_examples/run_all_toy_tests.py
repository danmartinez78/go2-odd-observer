...
def main():
    parser = argparse.ArgumentParser(description="Run all toy evaluation tests sequentially")
    parser.add_argument("--include-slow", action="store_true", help="Include slow tests (LLM judging)")
    parser.add_argument("--output", default="toy_test_results.json", help="Output file for results")
