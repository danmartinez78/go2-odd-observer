...
This directory contains comprehensive guides for the Go2 ODD Observer project.
...
- Quick start (3 steps to first analysis)
- Example use cases with code
- Processing your own ROS2 data
...
→ [GETTING_STARTED.md](GETTING_STARTED.md#-quick-start-run-your-first-analysis)
